...
inference(x= year, y = response, data = es, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
...
inference(x= year, y = response, data = us, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
